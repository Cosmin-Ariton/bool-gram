...
/***/ (() => {
  ...
  var app = new Vue({
    ...
    mounted: function mounted() {
      ...
      var axiosrequest1 = axios.get('https://flynn.boolean.careers/exercises/api/boolgram/profiles');
      var axiosrequest2 = axios.get('https://flynn.boolean.careers/exercises/api/boolgram/posts'); // all request
  
      axios.all([axiosrequest1, axiosrequest2]).then(function (response) {
        _this.profiles = response[0].data;
        _this.posts = response[1].data;
    ...
    methods: {
      skeletonTime: function skeletonTime() {
        var _this2 = this;
